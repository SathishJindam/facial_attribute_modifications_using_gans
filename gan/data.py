...
class Celeba(Dataset):
    ...
    def __init__(self,img_paths_, data_dir, atts, img_resize, batch_size, prefetch_batch=2, drop_remainder=True,
        ...
        #if crop:
        #    img_dir_jpg = os.path.join(data_dir, 'img_align_celeba_')
        #    img_dir_png = os.path.join(data_dir, 'img_align_celeba_png')
        #else:
        #    img_dir_jpg = os.path.join(data_dir, 'img_crop_celeba_')
        ...
        img_paths = [data_dir+name  for name in img_paths_]
...
if __name__ == '__main__':
    ...
    data = Celeba('./data', atts, 128, 32, part='train')
    batch = data.get_next()
    print(len(data))
